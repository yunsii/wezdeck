...
Agent may take host-side actions only when all of the following are true:

- [platform-actions-24] the action is a natural continuation of the current task
- [platform-actions-25] the action is low-risk and easy to understand
- [platform-actions-26] there is a stable wrapper or well-owned command boundary
...
- [platform-actions-29] what action was taken
- [platform-actions-30] what target was affected
- [platform-actions-31] whether follow-up is still needed from the user

[platform-actions-32] When it fails, report the failed action, the immediate reason if known, and whether the main task is still blocked.
