...
- [en/validation.md](./en/validation.md) — includes **adversarial review** (agent-operated platform skill; single source `skills/adversarial-review/`, user-level links via `link-platform-skills.sh`)
