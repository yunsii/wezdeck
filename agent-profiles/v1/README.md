...
- [en/validation.md](./en/validation.md) — includes **adversarial review** (agent-operated platform skill; single source `scripts/dev/adversarial-review/`, user-level links via `link-platform-skills.sh`)
...
- [en/dependency-triage.md](./en/dependency-triage.md) — dependency / upstream / internal-service fault triage playbook (includes out-of-branch → mainline gate)
