...
internal static class RuntimeCliResponseWriter
{
    public static void WriteEnv(RuntimeResponse? response, long elapsedMs)
    {
        if (response == null)
        {
            return;
        ...
        var lines = new List<string>
        {
            ...
            $"wezdeck_runtime_cli_elapsed_ms={elapsedMs}",
        };
