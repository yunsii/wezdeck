...
- Phone / Android access to the tmux sessions: Tailscale + ssh + Termux,
  the `tm` mirror-session helper, grouped-session window sizing, ghost
  clients, Termux Chinese input, or the Happy app-layer sync plan:
