...
- `r` in tmux copy-mode: manually refresh the copy-mode backing grid from the live pane while preserving scroll position. The same refresh also runs automatically every second while copy-mode is active
