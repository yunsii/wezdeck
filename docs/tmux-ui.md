...
stateDiagram-v2
  ...
  waiting --> [*]: focus-ack / Alt+/ / TTL /\nsame-pane eviction
  note right of waiting
    Counter filter and tab badge
    suppress the focused pane's
    entry at render time, then
    maybe_ack_focused forgets it
    within one update-status tick.
  end note
